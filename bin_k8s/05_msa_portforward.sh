...
kubectl port-forward -n msa svc/coupon-service 8091:8081 > "${ROOT_DIR}/coupon-port-forward.log" 2>&1 &
kubectl port-forward -n msa svc/point-service 8092:8082 > "${ROOT_DIR}/point-port-forward.log" 2>&1 &
