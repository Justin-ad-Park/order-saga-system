...
kubectl -n msa delete -f "${ROOT_DIR}/kafka.yaml"
kubectl -n msa delete deployment/zookeeper --ignore-not-found
kubectl -n msa delete svc/zookeeper --ignore-not-found
